...
#define STATUS_GPIO GPIO_NUM_16
...
static void file_operations(int slot)
{
    ...
    snprintf(file_path, sizeof(file_path), MNT_PATH "%d/test.txt", slot);
    ...
    if (stat(file_path, &s) != 0) {
        ...
        fprintf(f, "Hello from ESP32-S3 USB Host!\n");
        fprintf(f, "Pendrive write test successful.\n");
